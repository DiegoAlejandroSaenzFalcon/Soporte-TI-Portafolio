...
| [03 · Si algo falla: problemas, consejos y repaso](./gt-03-modulo-3-si-algo-falla-problemas-y-repaso.md) | Los 4 problemas más comunes con su solución + 4 frases de repaso | 2 min, para consultar |

## Diagramas de esta guía (se ven renderizados, uno por módulo)
...
|----------------|-------------|
| [Compartir internet desde un celular Android](https://support.google.com/android/answer/9059108?hl=es-419) | Activar hotspot/Zona Wi-Fi y conectar otros dispositivos |
...
3. **Di en voz alta** la frase de cada módulo mientras haces la acción (ayuda a memorizar).
...
**Versión imprimible con letra grande:** [gt-imprimible-letra-grande.html](./gt-imprimible-letra-grande.html) (ábrela en el navegador y pulsa Imprimir, o publica esta guía con GitHub Pages).

---

*Empezamos por el dibujo:* [Módulo 1 — Encender la Zona Wi-Fi del celular](./gt-01-modulo-1-encender-zona-wifi-del-celular.md)